...
<header id="header">
    <div class="d-flex justify-content-between px-5 pt-3 color-aqua-bg">
        ...
        <div class="phone-info font-size-1 ms-auto px-5 align-self-center">
            <p>(664) 625 11 11</p>
            <p>(664) 123 39 90</p>
        </div>
        <div class="font-size-1 align-self-center menu-usuario text-center d-flex">
            <div class="col btn-cuenta">
                <div><i class="fas fa-user-alt"></i></div>
                <div><a href="login.php" class="nav-menu-top px-3">Login</a></div>
            </div>
            <div class="col btn-favoritos">
                <div><i class="fas fa-heart"></i></div>
                <div><a href="favoritos.php" class="nav-menu-top px-3">Favoritos</a></div>
            </div>
            <div class="col btn-carrito">
                <div><i class="fas fa-shopping-cart"></i></div>
                <div><a href="carrito.php" class="nav-menu-top px-3">Carrito</a></div>
            </div>
            <div>
            <div><i class="fas fa-bars"></i></div>
                <a class="col nav-menu-top text-white mx-5 btn-usuario-dropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
           Menu
                </a>
    ...
    <!--pimary navigation-->
    <nav class="navbar navbar-expand-lg navbar-dark color-aqua-bg primary-navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php if ($pagina == "categorias") {echo "active";}?>" href="categorias.php" id="navbarDropdown" role="button"
                ...
                <form class="d-flex search-form me-5">
                    <input class="form-control search-page font-poppins search-bar me-2" type="search" placeholder="Search"
                           aria-label="Search">
