            ...
            <div class="container-fluid px-5">
                <div class="row px-5">
                    <div class="col-9 d-flex">
                        ...
                        <a class="btn btn-link2 align-self-end mb-4 color-red ss ms-auto" href="eliminar-carrito.php?nombre_login=<?php print $_SESSION['user_info']['nombre_login'];?>" role="button">Vaciar carrito</a>
                    </div>
                </div>
