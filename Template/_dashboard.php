...
<section>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <h2 class="section-title pt-5 text-center">Admin Dashboard</h2>
            ...
            <div class="col-lg-3 col-md-6 col-10">
                <a class="card dashboard-card mb-5 text-center" href="categorias/index.php">
                    <div class="card-img-top">
                        ...
                        <i class="dashboard-card-icon fa-solid fa-shirt pt-3 pb-5 color-orange"></i>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-10">
                <a class="card dashboard-card mb-5 text-center" href="eventos/index.php">
                    <div class="card-img-top">
                        ...
                        <i class="dashboard-card-icon fa-solid fa-gift pt-3 pb-5 color-orange"></i>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-10">
                <a class="card dashboard-card mb-5 text-center" href="pedidos/index.php">
                    <div class="card-img-top">
                        ...
                        <i class="dashboard-card-icon fas fa-file-invoice pt-3 pb-5 color-orange"></i>
                    </div>
                    <div class="card-body py-4">
