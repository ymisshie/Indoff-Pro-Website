...
<section>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <h1 class="section-title pt-md-5 text-center">Admin Dashboard</h1>
            <h6 class="pt-md-3 pb-md-4 fw-400">¿Que sección deseas editar?</h6>
        </div>

        <div class="row justify-content-evenly py-lg-3">
            <div class="col-lg-3 col-md-7">
                <a class="card dashboard-card mb-md-5 text-center" href="categorias/index.php">
                    ...
                    <div class="card-body py-md-4">
                        ...
                        <p class="fw-400 m-lg-0">Editar las categorias y los productos activos.</p>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-7">
                <a class="card dashboard-card mb-md-5 text-center" href="eventos/index.php">
                    ...
                    <div class="card-body py-md-4">
                        ...
                        <p class="fw-400 m-lg-0">Editar los eventos activos y los productos disponibles.</p>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-7">
                <a class="card dashboard-card mb-md-5 text-center" href="">
                    <div class="card-img-top">
                        <h3 class="fw-600 p-md-4 pb-md-0 color-purple text-end">1</h3>
                        <i class="dashboard-card-icon fa-solid fa-envelope-open-text  pt-md-3 pb-md-5 color-purple"></i>
                    </div>
                    <div class="card-body py-md-4">
                        <h5 class="fw-600">Información <i class="fa-solid fa-pen-to-square"></i></h5>
                        <p class="fw-400 m-lg-0">Editar los datos de inicio e información de contacto.</p>
                    </div>
                </a>
            </div>
