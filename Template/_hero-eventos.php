    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center color-white">
            <div class="col-lg-6 col-md-9 py-md-5 text-center">
                <h1 class="hero-title">Productos para toda ocasión</h1>
                <h6 class="col-md-8 mx-auto hero-description py-md-3 mb-0">Indoff Promocionales tiene un detalle para cada temporada. Observa la variedad que existe para el regalo ideal.</h6>
