    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 ps-4">
                <h4 class="section-title text-start m-0"><?php print $info_producto['nombre'] ?>
                </h4>
                <h6 class="py-2 font-size-09"><?php print $info_producto['proveedor'] ?></h6>
                ...
                <p class="font-size-09"><?php print $info_producto['descripcion'] ?></p>
                ...
                <div class="cantidad col-12 py-2 d-flex justify-content-between font-size-0.7">
                    <div class=" text-center mx-3">
                        <h6 class="font-poppins"><?php print $info_producto['op1'] ?></h6>
                    ...
                    <div class=" text-center mx-3">
                        <h6 class="font-poppins"><?php print $info_producto['op3'] ?></h6>
                        <input id="qtyS" class="qty-dropdown" type="number" name="qtyS" value="0">
                    </div>
                    <div class=" text-center mx-3">
                        <h6 class="font-poppins"><?php print $info_producto['op4'] ?></h6>
                        <input id="qtyS" class="qty-dropdown" type="number" name="qtyS" value="0">
                    </div>
                    <div class=" text-center mx-3">
                        <h6 class="font-poppins"><?php print $info_producto['op5'] ?></h6>
                        <input id="qtyS" class="qty-dropdown" type="number" name="qtyS" value="0">
                    </div>
                    <div class=" text-center mx-3">
                        <h6 class="font-poppins"><?php print $info_producto['op6'] ?></h6>
                        <input id="qtyS" class="qty-dropdown" type="number" name="qtyS" value="0">
                    </div>
                    <div class=" text-center mx-3">
                        <h6 class="font-poppins"><?php print $info_producto['op7'] ?></h6>
                        <input id="qtyS" class="qty-dropdown" type="number" name="qtyS" value="0">
                    </div>
