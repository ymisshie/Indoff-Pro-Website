<?php
$title = "Productos eventos";
$page_name = "productos-eventos";
...
if (!isset($_SESSION['admin_info']) or empty($_SESSION['admin_info'])) {
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        foreach ($info_producto as $productos) {
            if ($productos['evento_id'] == $info_categoria['id']) {
                $cantidad_productos++;
            }
        }
    } ?>
                    ...
                    <div class="col-md-12">
                        <div>
                            <div class="d-flex">
                                ...
                                <h2 class="fw-700 mb-0 align-self-center text-red">Productos de eventos en <?php print $info_categoria['nombre']; ?></h2>

                            </div>

                            <p class=""><?php print $cantidad_productos . ' productos de eventos'; ?></p>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col" class="">
                                            ...
                                            if ($count_imagen == 1) {
                                                ...
                                                $image = '../../../upload/Productos-Eventos/' . $item_producto['imagen'];
                                                ...
                                                <div id="carouselId" class="carousel slide w-100 carousel-dark" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner h-100" role="listbox">
                                                        ...
                                                        for ($ca = 0; $ca < $count_imagen; $ca++) {
                                                            $image = '../../../upload/Productos-Eventos/' . $separada_imagen[$ca];
