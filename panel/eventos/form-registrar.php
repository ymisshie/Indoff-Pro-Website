                ...
                <form method="POST" action="acciones.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex">
                            ...
                            <h2 class="fw-700 align-self-center text-red mb-0">Registro de evento</h2>
                        </div>
                    ...
                    <div class="row mt-4 text-muted justify-content-evenly">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <div class="form-floating">
                                        ...
                                        <label for="floatingInput" class="fw-600">Descripción del evento</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-5 form-card p-4 rounded">
                            ...
                            <div class="row pb-3">
                                <div>
                                    <label for="formFile" class="form-label fw-600">Imagen del evento</label>
