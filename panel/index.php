            ...
            <div class="col-6 formulario ws px-5 py-4 text-center ">
                <form action="login-admin.php" method="post"">
                    ...
                    <div class="col-12 align-items-center mx-auto py-2">
                        <h6 class="mb-0">¿No tiene una cuenta? <span><a href="form-register.php" class="btn ss color-red btn-link"> Crear Cuenta </a>
                            </span></h6>
                    </div>
                </form>
            </div>
