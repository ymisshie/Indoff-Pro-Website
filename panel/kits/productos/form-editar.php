<?php
$title = "Editar producto kit";
$page_name = "editar-productos-kits";
                                ...
                                <div class="col">
                                    <div class="form-floating">
                                        <select class="form-select" name="categoria_id_producto" required>
                                            ...
                                            <option value="<?php print 1; ?>"><?php print 'Kits'; ?></option>
                        ...
                        <div class="col-4 bg-info bg-white form-card p-4 rounded">
                            ...
                            <div class="row pb-3">
                                ...
                                <div class="gallery d-flex flex-wrap justify-content-evenly">
                                    ...
                                    for ($i = 0; $i < $count_imagenes; $i++) {
                                        ...
                                        $image = '../../../upload/Productos-Kits/' . $separada_imagenes[$i];
                            ...
                            <div class="row pb-3">
                                <div class="col">
                                    ...
                                    <a href="index.php?id=<?php print $info_producto['kits_id']; ?> " class="btn btn-secondary ms-3" role="buttton">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
