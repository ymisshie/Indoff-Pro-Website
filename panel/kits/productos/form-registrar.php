<?php
$title = "Añadir producto kit";
$page_name = "registro-productos-kits";
                ...
                <form method="POST" action="acciones.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex">
                            ...
                            <h3 class="fw-700 align-self-center text-red m-0">Registro de producto kit en <?php print $cat_nombre; ?></h3>
                        </div>
                    </div>
                                ...
                                <div class="col">
                                    <div class="form-floating">
                                        <select class="form-select" name="categoria_id_producto" required>
                                            ...
                                            $categoria2 = new ameri\Kits;
                                            $info_categorias = $categoria2->mostrar();
                                            $cantidad = count($info_categorias);

                                            ?>
                                            <option value="<?php print 1; ?>"><?php print $info_categoria['nombre']; ?></option>
