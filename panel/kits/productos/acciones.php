...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_POST['accion'] === 'Registrar') {
        ...
        $_params = array(
            ...
            'kits_id' => $_POST['categoria_id_producto'],
            'imagen' => subirFoto(),
            'fecha' => date('Y-m-d'),
        ...
        if ($rpt) {
            ...
            header("Location: index.php?id=" . $_params['kits_id']  . '&message=' . $message . '&estado=' . $estado);
        } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $categoria_id = $info_producto['kits_id'];
