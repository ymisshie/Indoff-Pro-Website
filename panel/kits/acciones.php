...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_POST['accion'] === 'Registrar') {
        ...
        if ($rpt) {
            $message = "Se ha añadido un kit satisfactoriamente.";
            $estado = "alert-success";
            header("Location: index.php?message=" . $message . "&estado=" . $estado);
        } else {
            $message = "Se ha producido un error al registrar el kit.";
    ...
    if ($_POST['accion'] === 'Actualizar') {
        ...
        if ($rpt) {
            $message = "Se ha actualizado un kit satisfactoriamente.";
            $estado = "alert-success";

            header("Location: ../categorias/index.php?message=" . $message . "&estado=" . $estado);
        } else {
            $message = "Se ha producido un error al actualizar el kit.";
            $estado = "alert-danger";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if ($rpt) {
        $message = "Se ha eliminado un kit satisfactoriamente.";
        $estado = "alert-success";

        header("Location: ../categorias/index.php?message=" . $message . "&estado=" . $estado);
    } else {
        $message = "Se ha producido un error al eliminar el kit.";
        $estado = "alert-danger";
