                ...
                <form method="POST" action="acciones.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex">
                            ...
                            <h3 class="fw-700 align-self-center text-red m-0">Editar de producto en <?php print $info_producto['nombre']; ?></h3>
                        </div>
                    </div>
                        ...
                        <div class="col-4 bg-info bg-white form-card p-4 rounded">
                            ...
                            <div class="row pb-3">
                                ...
                                <div class="gallery d-flex flex-wrap justify-content-evenly">
                                    ...
                                    for ($i = 0; $i < $count_imagenes; $i++) {
                                        ...
                                        $image = '../../../upload/Productos/' . $separada_imagenes[$i];
                            ...
                            <div class="row pb-3">
                                <div class="col">
                                    ...
                                    <a href="index.php?id=<?php print $info_producto['categoria_id']; ?> " class="btn btn-secondary ms-3" role="buttton">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
