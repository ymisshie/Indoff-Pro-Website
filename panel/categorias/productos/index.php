...
if (!isset($_SESSION['admin_info']) or empty($_SESSION['admin_info'])) {
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        foreach ($info_producto as $productos) {
            if ($productos['categoria_id'] == $info_categoria['id']) {
                $cantidad_productos++;
            }
        }
    } ?>
                    ...
                    <div class="col-md-12">
                        <div>
                            <div class="d-flex">
                                ...
                                <h2 class="fw-700 mb-0 align-self-center text-red">Productos en <?php print $info_categoria['nombre']; ?></h2>

                            </div>

                            <p class=""><?php print $cantidad_productos . ' productos'; ?></p>
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="form-card">
                            ...
                            foreach ($info_producto as $item_producto) {
                                if ($id == $item_producto['categoria_id']) {
                            ?>
