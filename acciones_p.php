...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_POST['accion'] === 'Registrar') {
        ...
        $_params = array(
            ...
            'precio1' => $_POST['precio_producto1'],
            'precio2' => $_POST['precio_producto2'],
            'precio3' => $_POST['precio_producto3'],
            'precio4' => $_POST['precio_producto4'],
            'precio5' => $_POST['precio_producto5'],
