                    ...
                    <ul class="navbar-nav my-3 my-md-0 mx-auto">
                        ...
                        ?>
                            ...
                            <li class="mt-md-0 nav-item pe-md-4">
                                <a class="px-3 px-md-3 nav-link" aria-current="page" href="<?php print $root_categorias . '?id=' . $item_cat['id']; ?>"><?php print $item_cat['nombre']; ?></a>
                            </li>
                        ...
                        ?>
                        <li class="mt-md-0 nav-item pe-md-4">
                            <a class="px-3 px-md-3 nav-link active" aria-current="page" href="<?php print $root_categorias . '?id=6'; ?>"><?php print $info_kit[0]['nombre']; ?></a>
                        </li>
                    </ul>
    ...
    <section id="producto" class="producto-hero">
        <div class="container">
            <div class="row justify-content-evenly">
                <!--IMAGEN DEL PRODUCTO-->
                <div class="p-0 col-12 col-lg-4 text-center producto-img align-self-center">
                    <?php
                ...
                <!--INFO DEL PRODUCTO-->
                <form class="py-5 px-5 col-12 col-lg-8 justify-content-between d-flex" method="POST" action="../../carrito/acciones-pi.php" enctype="multipart/form-data">
